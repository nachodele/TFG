...
1. Símbolos inaccesibles:
   ...
   - Ejemplo: Si  G = (N, T, S, P)  tiene  A ∈ N  pero no existe  S *{ →} xAy , entonces  A  es inaccesible.
...
2. Símbolos improductivos:
   ...
   - Ejemplo: Si  G = (N, T, S, P)  tiene  B ∈ N  pero no existe  B *{ →} w , con  w ∈ T^* , entonces  B  es improductivo.
