...
* Verificar que la gramática del enunciado esté en Forma Normal de Chomsky (FNC) antes de aplicar el algoritmo CYK.
   - Un único símbolo terminal.  
   - Exactamente dos símbolos no terminales.  
   - S → λ: solo el símbolo inicial.  
