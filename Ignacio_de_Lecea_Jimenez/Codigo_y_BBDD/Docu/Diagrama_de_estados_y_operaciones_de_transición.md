...
Sea una MT que acepta cadenas con igual número de  a's  seguidos por  b's . La tabla de estados es:
...
Las operaciones de transición definen cómo cambia el estado, qué se escribe en la cinta y hacia dónde se mueve la cabeza lectora/escritora. Estas operaciones están formalizadas mediante la función de transición  δ .
...
### Ejemplo: Transiciones para el Lenguaje  L = a^n b^n : n ≥ 1
