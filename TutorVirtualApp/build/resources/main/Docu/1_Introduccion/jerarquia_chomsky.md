...
- **Reglas de producción:** No tienen restricciones específicas; pueden tener cualquier forma \( \alpha \to \beta \), donde \( \alpha \) y \( \beta \) son cadenas de símbolos que incluyen terminales, no terminales o ambos.
- **Características:**
...
- **Reglas de producción:** De la forma \( \alpha A \beta \to \alpha \gamma \beta \), donde \( A \) es un símbolo no terminal, \( \alpha, \beta, \gamma \) son cadenas (posiblemente vacías), y \( |\gamma| \geq |A| \).
- **Características:**
...
- **Reglas de producción:** De la forma \( A \to \gamma \), donde \( A \) es un símbolo no terminal y \( \gamma \) es una cadena formada por terminales y/o no terminales.
- **Características:**
...
- **Reglas de producción:** De la forma:
  - Lineales por la derecha: \( A \to aB \) o \( A \to a \).
  - Lineales por la izquierda: \( A \to Ba \) o \( A \to a \).
- **Características:**
...
\[
\text{Lenguajes Regulares} \subseteq 
\text{Lenguajes Libres de Contexto} \subseteq 
\text{Lenguajes Sensibles al Contexto} \subseteq 
\text{Lenguajes Recursivamente Enumerables}
\]
...
| 1    | Sensibles al contexto       | Sensibles al contexto      | Autómata linealmente acotado| \( |\gamma| \geq |\alpha| \)        |
| 2    | Libres de contexto          | Libres de contexto         | Autómata con pila           | \( A \to \gamma\)                  |
