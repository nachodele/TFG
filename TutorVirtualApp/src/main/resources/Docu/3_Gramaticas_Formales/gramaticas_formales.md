...
- \( S \in N \): **Símbolo inicial** o axioma. Es el punto de partida para generar cadenas.
- \( P \): Conjunto finito de **reglas de producción**. Cada regla tiene la forma \( u \rightarrow v \), donde \( u \) y \( v \) son cadenas sobre \( N \cup T \), y \( u \neq \epsilon \) (no vacío).
...
|------|----------------------------|--------------------------------------------------|------------------------------|-----------------------------|
| 0    | Sin restricciones          | \( u \rightarrow v \), donde \( u, v \in (N \cup T)^* \) y \( u \neq \epsilon \) | Lenguajes recursivamente enumerables | Máquina de Turing          |
| 1    | Sensibles al contexto      | \( xAy \rightarrow xvy \), donde \( A \in N, v \neq \epsilon \)               | Lenguajes sensibles al contexto | Autómata linealmente acotado |
| 2    | Libres de contexto         | \( A \rightarrow v \), donde \( A \in N, v \in (N \cup T)^* \)                | Lenguajes libres de contexto  | Autómata de pila            |
| 3    | Regulares                  | \( A \rightarrow aB, A \rightarrow a, A \rightarrow \epsilon\), con restricciones específicas | Lenguajes regulares          | Autómata finito            |
