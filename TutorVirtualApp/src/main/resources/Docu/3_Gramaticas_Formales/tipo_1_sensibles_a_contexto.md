...
- \( P \): Conjunto finito de **reglas de producción** de la forma:
  \[
  \gamma_1 A \gamma_2 \rightarrow \gamma_1 \omega \gamma_2
  \]
  Donde:
  - \( A \in N \) es un símbolo no terminal.
  - \( \gamma_1, \gamma_2, \omega \in (N \cup T)^* \) son cadenas de símbolos terminales y/o no terminales.
  - \( |\gamma_1 A \gamma_2| \leq |\gamma_1 \omega \gamma_2| \), es decir, la longitud del lado derecho debe ser mayor o igual a la del lado izquierdo.
