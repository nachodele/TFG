...
En teoría de lenguajes formales, un **contexto válido** describe las condiciones bajo las cuales una palabra  x  pertenece a un lenguaje  L . Formalmente, se dice que un par de palabras  (u, v) , donde  u, v ∈ Σ^*  (el conjunto de todas las cadenas posibles sobre un alfabeto  Σ ), es un contexto válido de  x  en  L  si y solo si:
...
- Si  (u, λ)  es un contexto válido de  x  en  L , entonces  u  se denomina **prefijo válido** de  x .
- Si  (λ, v)  es un contexto válido de  x  en  L , entonces  v  se denomina **sufijo válido** de  x .

Aquí, el símbolo  λ  representa la palabra vacía.

---

## **Ejemplo Práctico**

Sea el alfabeto  Σ = 0, 1  y el lenguaje definido como:
...
Determinemos cuáles de los siguientes pares son contextos válidos para estas palabras:
 (0, 0), (0, 1), (1, 0), (1, 1), (λ, 00), (λ, 01), (λ, 10), (λ, 11), (00, λ), (01, λ), (10, λ), (11, λ) .
...
1. **Relación basada en Prefijos Válidos ( PL):**
   Dos palabras  x, y ∈ L son equivalentes si tienen el mismo conjunto de prefijos válidos en el lenguaje. Esto se denota como:
