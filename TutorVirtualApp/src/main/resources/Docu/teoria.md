...
### Ejemplo:
Si  Σ = a, b , entonces:
-  Σ^* = ε, a, b, aa, ab, ba, bb, ... , donde  ε  es la palabra vacía.
- Un lenguaje podría ser  L = a^n b^n : n ≥ 0 , que contiene palabras como  ε, ab, aabb, aaabbb, ....
...
### Ejemplo:
Para la gramática  G = (S, a, b, P, S) , con  P = S → aSb | ab :
