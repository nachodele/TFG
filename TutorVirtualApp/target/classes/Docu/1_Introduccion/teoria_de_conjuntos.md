...
### Conjunto
Un **conjunto** es una colección de objetos considerados como una unidad. Cada objeto en un conjunto se denomina **elemento**. Si un elemento \(x\) pertenece a un conjunto \(A\), se denota como \(x \in A\). Si no pertenece, se escribe \(x \notin A\).

Ejemplo:
- \(A = \{1, 2, 3\}\), donde \(1 \in A\) y \(4 \notin A\).

### Conjunto Vacío
El **conjunto vacío**, denotado por \( \emptyset \) o \( \{\} \), es el conjunto que no contiene ningún elemento.

### Subconjunto
Un conjunto \(A\) es un **subconjunto** de otro conjunto \(B\) (denotado como \(A \subseteq B\)) si todos los elementos de \(A\) también están en \(B\).
...
Ejemplo:
- Si \(X = \{a, b\}\), entonces \(P(X) = \{\emptyset, \{a\}, \{b\}, \{a, b\}\}\).
...
### Unión
La **unión** de dos conjuntos \(A\) y \(B\), denotada como \(A \cup B\), es el conjunto que contiene todos los elementos que están en \(A\), en \(B\), o en ambos.

Ejemplo:
- Si \(A = \{1, 2\}\) y \(B = \{2, 3\}\), entonces \(A \cup B = \{1, 2, 3\}\).

### Intersección
La **intersección** de dos conjuntos \(A\) y \(B\), denotada como \(A \cap B\), es el conjunto que contiene los elementos comunes a ambos conjuntos.

Ejemplo:
- Si \(A = \{1, 2\}\) y \(B = \{2, 3\}\), entonces \(A \cap B = \{2\}\).
...
Un conjunto es numerable si puede establecerse una biyección con los números naturales (\( |\mathbb{N}| = \aleph_0 \)).
...
Un conjunto es no numerable si su cardinalidad excede la de los números naturales (\( |X| > |\mathbb{N}| = \aleph_0 \)).

Ejemplos:
- Los números reales (\( \mathbb{R} \)).
- El conjunto potencia de los números naturales (\( P(\mathbb{N}) \)).
